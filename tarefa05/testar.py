...
class Task(BaseTask):
    def teste_1_adicionar(self):
        cases = self.case_range("adicionar{}.in", 1, 2)
        binary = self.make("deque_herois")
        self.test_cases(binary, cases)
    def teste_2_remover(self):
        cases = self.case_range("remover{}.in", 1, 3)
        binary = self.make("deque_herois")
        self.test_cases(binary, cases)
    def teste_3_pequenos(self):
        cases = self.case_range("pequeno{}.in", 1, 5)
        binary = self.make("deque_herois")
        self.test_cases(binary, cases)
    def teste_4_medios(self):
        cases = self.case_range("medio{}.in", 1, 4)
        binary = self.make("deque_herois")
        self.test_cases(binary, cases)
    def teste_5_grandes(self):
        cases = self.case_range("grande{}.in", 1, 5)
        binary = self.make("deque_herois")
        self.test_cases(binary, cases)
    def teste_6_bordas(self):
        cases = self.case_range("borda{}.in", 1, 2)
        binary = self.make("deque_herois")
        self.test_cases(binary, cases)
    def teste_7_caos(self):
        cases = self.case_range("caos{}.in", 1, 2)
        binary = self.make("deque_herois")
        self.test_cases(binary, cases)
    def teste_8_confusao(self):
        cases = self.case_range("confusao{}.in", 1, 2)
        binary = self.make("deque_herois")
        self.test_cases(binary, cases)
    def teste_9_atacar(self):
        cases = self.case_range("atacar{}.in", 1, 3)
        binary = self.make("deque_herois")
        self.test_cases(binary, cases)
