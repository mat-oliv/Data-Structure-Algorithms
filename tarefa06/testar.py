...
class Task(BaseTask):
    def teste_1_print(self):
        cases = self.case_range("print{}.in", 1, 2)
        binary = self.make("gattaca")
        self.test_cases(binary, cases)

    def teste_2_insert(self):
        cases = self.case_range("insert{}.in", 1, 3)
        binary = self.make("gattaca")
        self.test_cases(binary, cases)

    def teste_3_remove(self):
        cases = self.case_range("remove{}.in", 1, 3)
        binary = self.make("gattaca")
        self.test_cases(binary, cases)

    def teste_4_pequenos(self):
        cases = self.case_range("pequeno{}.in", 1, 3)
        binary = self.make("gattaca")
        self.test_cases(binary, cases)

    def teste_5_medios(self):
        cases = self.case_range("medio{}.in", 1, 3)
        binary = self.make("gattaca")
        self.test_cases(binary, cases)

    def teste_6_grandes(self):
        cases = self.case_range("grande{}.in", 1, 3)
        binary = self.make("gattaca")
        self.test_cases(binary, cases)
