...
class Task(BaseTask):
    def teste_1_inserir(self):
        cases = self.case_range("inserir{}.in", 1, 4)
        binary = self.make("hashtags")
        self.test_cases(binary, cases)

    def teste_2_remover(self):
        cases = self.case_range("remover{}.in", 1, 4)
        binary = self.make("hashtags")
        self.test_cases(binary, cases)
        
    def teste_3_alterar(self):
        cases = self.case_range("alterar{}.in", 1, 4)
        binary = self.make("hashtags")
        self.test_cases(binary, cases)
    
    def teste_4_tags(self):
        cases = self.case_range("tags{}.in", 1, 5)
        binary = self.make("hashtags")
        self.test_cases(binary, cases)
