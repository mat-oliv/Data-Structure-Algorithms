...
class Task(BaseTask):
    def teste_1_drama(self):
        cases = self.case_range("drama{}.in", 1, 3)
        binary = self.make("drama")
        self.test_cases(binary, cases)

    def teste_2_cpf(self):
        cases = self.case_range("cpf{}.in", 1, 8)
        binary = self.make("cpf")
        self.test_cases(binary, cases)

    def teste_3_auau(self):
        cases = self.case_range("auau{}.in", 1, 8)
        binary = self.make("auau")
        self.test_cases(binary, cases)
