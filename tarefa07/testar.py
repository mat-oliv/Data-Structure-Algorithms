...
class Task(BaseTask):
    ...
    def teste_1_maximo(self):
        cases = self.case_range("maximo{}.in", 1, 3)
        binary = self.make("agenda")
        self.test_cases(binary, cases)

    def teste_2_minimo(self):
        cases = self.case_range("minimo{}.in", 1, 2)
        binary = self.make("agenda")
        self.test_cases(binary, cases)

    def teste_3_combinado(self):
        cases = self.case_range("combinado{}.in", 1, 2)
        binary = self.make("agenda")
        self.test_cases(binary, cases)

    def teste_4_altera(self):
        cases = self.case_range("altera{}.in", 1, 2)
        binary = self.make("agenda")
        self.test_cases(binary, cases)

    def teste_5_pequeno(self):
        cases = self.case_range("pequeno{}.in", 1, 4)
        binary = self.make("agenda")
        self.test_cases(binary, cases)

    def teste_6_medio(self):
        cases = self.case_range("medio{}.in", 1, 4)
        binary = self.make("agenda")
        self.test_cases(binary, cases)

    def teste_7_grande(self):
